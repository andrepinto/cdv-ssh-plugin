cordova.define("com.tlantic.plugins.ssh.SSH", function(require, exports, module) { /* global module, require */
    'use strict';
    ...
    // connect method
    SSH.prototype.connect = function(host, port, username, password, successCallback, errorCallback) {
        exec(successCallback, errorCallback, this.pluginRef, 'connect', [host, port, username, password]);
    };
